...
public class RequestServletListener extends CurrencyExchange<CurrencyRateDTOList> implements ServletRequestListener{
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        NhiSaveProperties saveProperties = new NhiSaveProperties();
        saveProperties.saveProInXml(AppConstant.srcMachineProp, AppConstant.srcMachineXML);
        saveProperties.saveProInXml(AppConstant.srcTimerProp, AppConstant.srcTimerXML);
        saveProperties.saveProInXml(AppConstant.srcVietBaoProp, AppConstant.srcVietBaoXML);
        saveProperties.saveProInXml(AppConstant.srcWebGiaProp, AppConstant.srcWebGiaXML);
