 ...
 * @author admin
 */
public class MybossCetegoriesCrawler extends BaseCrawler {
        ...
        try {
            ...
            while ((line = reader.readLine().trim()) != null) { //<li class=\"title-sub\"><a class=\"a-sub\" href=\"/collections/skin-care\">
                ...
                if (isStart && !end) {//EXFOLIATE</a>
                    //Viêm da cơ địa</a>
                    if (line.contains("<span>Mặt nạ dưỡng da")) {
                        document += line;
                        break;
                    }
            ...
            Logger.getLogger(MybossCetegoriesCrawler.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public Map<String, String> sTAXPaeserForCatergories(String document) throws UnsupportedEncodingException, XMLStreamException, IOException {
        ...
        for (int i = 0; i < categories.size(); i++) {
            System.out.println("Cate " + categories.get(i));
