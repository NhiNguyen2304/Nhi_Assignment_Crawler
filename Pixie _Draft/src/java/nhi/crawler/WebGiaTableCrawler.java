...
public class WebGiaTableCrawler extends BaseCrawler {
    ...
    public boolean getCurrencyFromURL(String baseUrl, String date, int type) {
        ...
        try {
            ...
            String boxStart = getConfigProperties("startBox", AppConstant.srcWebGiaXML,
                    this.getClass().getSimpleName());
            String boxEnd = getConfigProperties("endBox", AppConstant.srcWebGiaXML,
                    this.getClass().getSimpleName());
...
//                    }
    ...
    public boolean getCurrencyUrl(String url, String date) {
        ...
        try {
            ...
            String tableStart = getConfigProperties("start", AppConstant.srcWebGiaXML,
                                            this.getClass().getSimpleName());
            String tableEnd = getConfigProperties("end", AppConstant.srcWebGiaXML,
                                            this.getClass().getSimpleName());
    ...
    private boolean sTAXPaeserForCurrency(String document, String date) throws UnsupportedEncodingException, XMLStreamException, IOException {
        ...
        NhiGetProperties prop = new NhiGetProperties();
        thTag = getConfigProperties("th", AppConstant.srcWebGiaXML,
                                            this.getClass().getSimpleName());
        tdTag = getConfigProperties("td", AppConstant.srcWebGiaXML,
                                            this.getClass().getSimpleName());
        hiddenTag = getConfigProperties("hidden", AppConstant.srcWebGiaXML,
                                            this.getClass().getSimpleName());
        while (eventReader.hasNext()) {
